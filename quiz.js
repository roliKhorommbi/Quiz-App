const questions = [
  {
    ...
    answers: [
      ...
      { text: "Hypertext Mark Level", correct: false },
      { text: "Hypertext Markup Leveler", correct: false },
      { text: "Hypertrainer Marking Language", correct: false },
    ],
  },
  ...
  {
    question: "Which one is NOT a legal identifier?",
    answers: [
      { text: "Spam", correct: false },
      { text: "spAm", correct: false },
      { text: "2spam", correct: true },
